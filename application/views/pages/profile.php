    ...
    <div class="mt-5 container-md">
        <div class="form-bg">
            <div class="mx-auto">
				...
				<h4 class="pt-2 txt-xl px-5 mx-5">Teid on määratud <?php if($this->session->userdata['roleID']=='2'){echo "peaadministraatoriks";}else{echo 'administraatoriks';};?> asutuses <?php echo $editProfile[0]['name'];?>. Rolli kinnitamisel annate loa juurdepääsuks teistele asutusega seotud kasutajatele teie nimele ja telefoni numbrile. 
				</h4>
				...
				<div class="d-flex p-0 mt-4 px-5 mx-5">
					<div class="form-label-group col-12 col-md-6 py-0 pl-0 pr-5">
						...
						<select id="giveaccess" name="giveaccess" class="form-control arrow" >
                                    <option value="0"> Kinnitan <?php if($this->session->userdata['roleID']=='2'){echo "peaadministraatori";}else{echo 'administraatori';};?> rolli</option>
