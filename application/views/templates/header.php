...
<!-- Navigation -->
    <header>
        <nav class="navbar navbar-expand-md custom-height p-0 nav-bg">
                  ...
                  <ul class="navbar-nav mr-auto mt-lg-0 pl-lg-3 pl-md-2 pl-sm-1">
									...
									<?php if(array_key_exists('building',$this->session->userdata())){?>
											...
											<?php	if($this->session->userdata('room')){?>
													...
													<li class="nav-item"><a class="nav-link text-white px-4    py-2 mr-lg-0 mr-md-0 mr-sm-0" href="<?php echo base_url(); ?>fullcalendar?roomId=<?php echo $this->session->userdata('room');?>">  <?php if($menu=='calendar'){echo ' <div title="Kalender"><img class="navlogo" src="\spordiruumid\assets\img\kalender2.png"	alt="logo"></div>';} else {echo ' <div title="Kalender"><img class="navlogo" src="\spordiruumid\assets\img\kalender3.png"	alt="logo"></div>';} ?>  </a></li>
													<li class="nav-item"><a class="nav-link text-white px-4    pr-lg-5 pr-md-2 pr-sm-1 py-2 mr-lg-0 mr-md-0 mr-sm-0" href="<?php echo base_url(); ?>allbookings/"><div title="Broneeringud"></div> <?php if($menu=='allbookings'){echo ' <div title="Broneeringud"><img class="navlogo" src="\spordiruumid\assets\img\list2.png"	alt="logo"></div>';} else {echo '<div title="Broneeringud"><img class="navlogo" src="\spordiruumid\assets\img\list1.png"	alt="logo"></div>';} ?>  	<?php if(isset($unapprovedBookings)){ if($unapprovedBookings!=0){echo '<span class="badge badge-danger">'.$unapprovedBookings.'</span>';}}; ?></a></li>
                      <?php } ?>
            
													<?php endif; ?>
											<?php if($this->session->userdata('roleID')==='1'):?>
													<li class="nav-item"><a class="nav-link text-white  pr-lg-5 pr-md-2 py-2 pr-sm-1 mr-lg-0 mr-md-0 mr-sm-0" href="<?php echo base_url(); ?>building/view/"><?php if($menu=='building'){echo ' <div title="Asutused"><img class="navlogo" src="\spordiruumid\assets\img\building2.png"	alt="logo"></div>';} else {echo '<div title="Asutused"><img class="navlogo" src="\spordiruumid\assets\img\building1.png"	alt="logo"></div>';} ?></a></li>
													<li class="nav-item"><a class="nav-link text-white  pr-lg-5 pr-md-2 py-2 pr-sm-1 mr-lg-0 mr-md-0 mr-sm-0" href="<?php echo base_url(); ?>region/view/"><?php if($menu=='region'){echo '<div title="Piirkond"><img class="navlogo" src="\spordiruumid\assets\img\piirkond2.png"	alt="logo"></div>';} else {echo '<div title="Piirkond"><img class="navlogo" src="\spordiruumid\assets\img\piirkond3.png"	alt="logo"></div>';} ?> </a></li>
											<?php endif; ?>
											<?php if( $this->session->userdata('roleID')==='1' || $this->session->userdata('roleID')==='2' ||$this->session->userdata('roleID')==='3'):?>
													<li class="nav-item"><a class="nav-link text-white  pr-lg-5 pr-md-2 py-2 pr-sm-1 mr-lg-0 mr-md-0 mr-sm-0" href="<?php echo base_url(); ?>manageUsers"> <div title="Kasutajad"></div><?php if($menu=='users'){echo ' <div title="Kasutajad"><img class="navlogo" src="\spordiruumid\assets\img\kasutajad2.png"	alt="logo"></div>';} else {echo '<div title="Kasutajad"><img class="navlogo" src="\spordiruumid\assets\img\kasutajad1.png"	alt="logo"></div>';} ?></a></li>
											<?php endif; ?>
											<?php if($this->session->userdata('roleID')==='2' || $this->session->userdata('roleID')==='3'):?>
													<li class="nav-item"><a class="nav-link text-white  pr-lg-5 pr-md-2 py-2 pr-sm-1 mr-lg-0 mr-md-0 mr-sm-0" href="<?php echo base_url(); ?>building/view/<?php  print_r($this->session->userdata['building']);  ?>"><div title="Asutuse sätted"></div><?php if($menu=='building'){echo ' <div title="Asutuse sätted"><img class="navlogo" src="\spordiruumid\assets\img\settings2.png"	alt="logo"></div>';} else {echo '<div title="Asutuse sätted"><img class="navlogo" src="\spordiruumid\assets\img\settings1.png"	alt="logo"></div>';} ?></a></li>
											<?php endif; ?>
										
									<?php ;}  if(!empty($this->session->userdata('userID'))){?>
												<li class="nav-item"><a class="nav-link text-white py-2" href="<?php echo base_url(); ?>profile/edit/<?php echo $this->session->userdata('userID');?>"><div title="Profiil"></div> <?php if($menu=='profile'){echo ' <div title="Profiil"><img class="navlogo" src="\spordiruumid\assets\img\kasutaja2.png"	alt="logo"></div>'.$this->session->userdata('').' </u></strong>';} else {echo '<div title="Profiil"><img class="navlogo" src="\spordiruumid\assets\img\kasutaja1.png"	alt="logo"></div>'.$this->session->userdata('').' ';} ?>  	<?php if(isset($requestFromBuilding)){if($requestFromBuilding['requestFromBuilding']=='1'){echo '<span class="badge badge-danger">1</span>';}} ?></a></li>
									<?php ;}?>
