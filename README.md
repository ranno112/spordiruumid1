...
Käesolev töö on GNU v3 litsentsi all ning kõigile huvilistele vabalt kättesaadav. Täpsemalt loe litsentsitingimusi litsentsifailist. Rakendus kasutab FullCalendar Premium moodulit erilitsentsi all, seega igasugune rakenduse funktsionaalsuse lisamine või muutmine peab olema lähtekoodina avalik. Täpsem info https://fullcalendar.io/license/premium. Kui te ei soovi lähtekoodi avaldada, tuleb teil kogu FullCalendar Premium moodul rakendusest eemaldada kustutades vaadetest allweekBookings.php fail.
